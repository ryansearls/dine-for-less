...
restaurant = Restaurant.create!(name:"Occidental", neighborhood:"Highland", food_specials:"N/A", happy_hour:"TallBoy PBR $3.50", image:"https://cdn.vox-cdn.com/thumbor/jpPjjfUWb-U04qAelp67mG0LzHI=/1200x0/filters:no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/4046538/OCCIDENTAL_4358e.0.jpg")

restaurant = Restaurant.create!(name:"Highland Tap and Burger", neighborhood:"Highland", food_specials:"N/A", happy_hour:"$5 Drafts from 4-7", image:"https://denver.thedrinknation.com/uploads/2013-11-13-htb-patio-690x420.jpg")
